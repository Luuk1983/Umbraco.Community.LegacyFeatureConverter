...
namespace Umbraco.Community.LegacyFeatureConverter.Data.Migrations.Sqlite
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Summary = table.Column<string>(type: "TEXT", maxLength: 2147483647, nullable: true),
                    SelectedDocumentTypes = table.Column<string>(type: "TEXT", maxLength: 2147483647, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "LegacyFeatureConverterQueue",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    SerializedOptions = table.Column<string>(type: "TEXT", maxLength: 2147483647, nullable: false),
                    QueuedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    StartedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CompletedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Status = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    ConversionHistoryId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LegacyFeatureConverterQueue", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Details = table.Column<string>(type: "TEXT", maxLength: 2147483647, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LegacyFeatureConverterQueue_QueuedAt",
                table: "LegacyFeatureConverterQueue",
                column: "QueuedAt");

            migrationBuilder.CreateIndex(
                name: "IX_LegacyFeatureConverterQueue_Status",
                table: "LegacyFeatureConverterQueue",
                column: "Status");
        }
